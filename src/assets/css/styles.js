...
const globalStyles = StyleSheet.create({ 
    ...
    activityIndicator: {     
     ...
     appImgBackGround : { 
        ...
        resizeMode: 'cover',
        paddingHorizontal:0.026*windowHeight,
       ...
       selectedTabItemsText : {
        ...
        headerLargeText: {
          ...
          bigContainer: {
            ...
            paddingHorizontal:0.03*windowHeight,
            
            alignSelf: 'flex-start',
            justifyContent: 'flex-start',
            // marginBottom:0.13*windowHeight,
        ...
        row: {
         ...
         card:{
            ...
            width: 0.186*windowHeight,
            height:0.15*windowHeight,
            borderRadius: 0.032*windowHeight,
            marginTop:0.029*windowHeight,
            marginBottom:Math.round((10 * width) / 400),
            paddingTop:0.02*windowHeight,
            paddingHorizontal:0.024*windowHeight,
         ...
         dashBoardAppBar:{
            ...
            paddingHorizontal:Math.round((20 * width) / 400),
            alignItems: 'center', 
            justifyContent: 'space-between',
            backgroundColor:'white'
          //  marginBottom: 20,
